...
public class ObeseLunchList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<TypeFoodHelper> options =
                new FirebaseRecyclerOptions.Builder<TypeFoodHelper>().setQuery(
                        FirebaseDatabase.getInstance().getReference().child("Diet").child("Bmitype").child("Obese").child("Lunch"), TypeFoodHelper.class
                ).build();
