...
public class ObeseSnackList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<TypeFoodHelper> options =
                new FirebaseRecyclerOptions.Builder<TypeFoodHelper>().setQuery(
                        FirebaseDatabase.getInstance().getReference().child("Diet").child("Bmitype").child("Obese").child("Snacks"), TypeFoodHelper.class
                ).build();
