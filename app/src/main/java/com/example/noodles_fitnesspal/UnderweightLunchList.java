...
public class UnderweightLunchList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Lunch Options");
        ActionBar ab = getSupportActionBar();
        ab.setDisplayHomeAsUpEnabled(true);
        FirebaseRecyclerOptions<TypeFoodHelper> options =
                new FirebaseRecyclerOptions.Builder<TypeFoodHelper>().setQuery(
                        FirebaseDatabase.getInstance().getReference().child("Diet").child("Bmitype").child("Underweight").child("Lunch"), TypeFoodHelper.class
                ).build();
